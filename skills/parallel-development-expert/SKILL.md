...
You: "These 3 features are independent! I can run them in parallel using git worktrees with Promptune:
...
You: "I can help speed this up! Are the features independent? If so, I can use Promptune to run them in parallel using separate git worktrees.
...
You: "Git worktrees allow you to work on multiple branches simultaneously. Promptune automates this for parallel development:
...
- Promptune uses Haiku agents (87% cheaper than Sonnet)
