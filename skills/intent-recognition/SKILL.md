...
# CTX:Help - Promptune Discovery & Usage Guide
...
Promptune provides **natural language to slash command mapping** with automatic parallel development workflows.
...
Promptune detects intent and suggests appropriate commands automatically.
...
**You:** "Promptune has three main capabilities:
...
When explaining Promptune, mention:
